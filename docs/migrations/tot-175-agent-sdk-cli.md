...
The intended public versions are `totto2727/agent-sdk@0.1.0`, `totto2727/codex-sdk@0.2.0`, and `totto2727/opencode-sdk@0.3.0`. Until those versions are published, CI validates with target-unspecified commands and a temporary `moon.work` overlay pinned to agent-sdk commit `e7c0d59d63074979082496ab422d5de695d4d90f`, Codex SDK commit `15577d304a2b5888d4032de406176254754ccb57`, OpenCode SDK commit `03660eca982c7867155ff17dff0aced279a22902`, and agent-core-sdk commit `127a11e9c4b0bf0067e3082a55af0a44e69c5fe0`. Each module's preferred target governs CI validation, while the repository `moon.work` remains registry-only.
