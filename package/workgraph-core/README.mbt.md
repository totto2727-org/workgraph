...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------- | ----------------- |
| `totto2727/workgraph-core`          | Graph definitions, compiled graphs, sequential runtime, state reducers, events, and in-memory `ResourceStore` | native           | native, js        |
| `totto2727/workgraph-agent-cli`     | Coding-agent node and session resource lifecycle                                                              | native           | native            |
| `totto2727/workgraph-llm`           | Provider-neutral `mizchi/llm@0.3.1` node boundary                                                             | native           | native, js        |
| `totto2727/workgraph-visualization` | Mermaid rendering from compiled graph snapshots                                                               | native           | native, js        |
