...
- `workgraph-codex-cli` and `workgraph-opencode-cli` prefer native and support Wasm/WASI and native from the same production source. Process integration tests and real CLI examples remain native-only.
